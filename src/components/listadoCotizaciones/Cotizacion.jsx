...
export default function Cotizacion({ cotizacion }) {
  const { nombreAsegurado, placa, prima, mejorAseguradora, fechaCotizacion, estado } = cotizacion
  ...
  return (
    <li className='py-2 flex items-center border-b-2 justify-between'>
      ...
      <div className='w-2/6 lg:w-3/12 flex items-center flex-col lg:flex-row lg:gap-2'>
        <p className='font-bold text-gray-700'>{mejorAseguradora}</p>
        <p className='text-sm '>$ {prima}</p>
      </div>

      <div className='w-1/6 lg:w-3/12flex items-center flex-col lg:flex-row lg:gap-2'>
        <p className='font-bold text-gray-700'>{estado}</p>
        <p className='text-sm text-gray-700'>{fechaCotizacion}</p>
      </div>
